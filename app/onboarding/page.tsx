    ...
    try {
      if (isBuyer) {
        const buyerProfile = {
          ...
          interests: formData.primaryCrops, // crops they are interested in buying
          preferredContactMethod: formData.preferredContactMethod,
          hasSmartphone: formData.hasSmartphone,
          followedFarmers: Array.from(selectedFarmerIds),
          registrationDate: new Date(),
          profileComplete: true,
        }
        await setDoc(doc(db, `buyers/${user.uid}`), buyerProfile)
        await updateProfile(buyerProfile)
        ...
        await updateProfile(farmerProfile)
