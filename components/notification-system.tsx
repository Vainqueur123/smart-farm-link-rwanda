...
export function NotificationSystem({ className }: NotificationSystemProps) {
  ...
  // Mock notifications for demo - in production, fetch from Firebase
  useEffect(() => {
      ...
      const mockNotifications: Notification[] = [
        {
          ...
          userId: user.id,
          type: 'success',
          title: 'Welcome to Smart Farm Link',
        ...
        },
        {
          ...
          message: 'Add more details to your profile to get better recommendations',
          isRead: false,
